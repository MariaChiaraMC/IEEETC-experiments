// Benchmark "./pla/test4.pla_dbb_orig_3NonExact" written by ABC on Fri Nov 20 10:30:21 2020

module \./pla/test4.pla_dbb_orig_3NonExact  ( 
  ...
  assign new_n35_ = new_n30_ & new_n31_;
  ...
  assign new_n57_ = ~x5 & new_n52_;
  assign new_n58_ = ~x7 & new_n10_;
  ...
  assign new_n66_ = ~new_n52_ & new_n53_;
  ...
  assign new_n80_ = ~new_n16_ & ~new_n56_;
  assign new_n81_ = ~x7 & new_n11_;
  assign new_n82_ = ~new_n12_ & ~new_n81_;
  assign new_n83_ = ~new_n24_ & ~new_n82_;
  assign new_n84_ = ~new_n80_ & new_n83_;
  assign new_n85_ = x7 & ~new_n10_;
  assign new_n86_ = ~x1 & ~new_n36_;
  ...
  assign new_n96_ = new_n12_ & new_n54_;
  assign new_n97_ = ~x2 & new_n96_;
  assign z0 = new_n95_ | new_n97_;
endmodule
